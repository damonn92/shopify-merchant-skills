...
├── logs/
│   └── 2026-05-09.log      # one log per day, .draft.json saved alongside
...
export SHOPIFY_BLOG_GID="gid://shopify/Blog/120042029420"
export ANTHROPIC_API_KEY="sk-ant-..."
export ANTHROPIC_MODEL="claude-haiku-4-5"   # cheap+fast for blog drafts
export STORE_BRAND_NAME="Calivell"
export STORE_DOMAIN="calivell.com"
```
...
<dict>
  <key>Label</key>
  <string>com.calivell.daily-blog</string>
  <key>ProgramArguments</key>
  <array>
    <string>/bin/bash</string>
    <string>-c</string>
    <string>source /Users/damon/bin/calivell-blog/config.env && /usr/bin/python3 /Users/damon/bin/calivell-blog/publish.py</string>
  </array>
  ...
  <string>/Users/damon/bin/calivell-blog/logs/launchd.out.log</string>
  <key>StandardErrorPath</key>
  <string>/Users/damon/bin/calivell-blog/logs/launchd.err.log</string>
</dict>
</plist>
```
...
Load it:
```bash
launchctl load ~/Library/LaunchAgents/com.calivell.daily-blog.plist
...
- Calivell first auto-published article: 2026-04-17 (still live)
- KZG first auto-published: 2026-04-18 — "How to Measure a Shower Opening for a Replacement Door"
- Disabled remote-trigger approach (Anthropic CCR sandbox blocks `xkemzr-me.myshopify.com` via network allowlist; we fell back to local launchd)
